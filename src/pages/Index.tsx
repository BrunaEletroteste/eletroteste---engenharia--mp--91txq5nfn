    ...
    <div className="space-y-6">
      <Tabs defaultValue="dashboard" className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-background p-4 rounded-xl shadow-sm border">
          <TabsList className="w-full sm:w-auto h-auto p-1 bg-muted/50 gap-1">
            <TabsTrigger value="dashboard" className="flex-1 sm:flex-none">
              Dashboard
            </TabsTrigger>
            <TabsTrigger value="listagem" className="flex-1 sm:flex-none">
              Listagem
            </TabsTrigger>
          </TabsList>
        ...
        <TabsContent
          value="listagem"
          className="space-y-6 m-0 focus-visible:outline-none focus-visible:ring-0"
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="w-full sm:w-80">
              {user?.tipo_acesso === 'admin' ? (
                ...
                <div className="text-sm font-medium text-muted-foreground p-2 border rounded-md bg-muted/20">
                  Seus relatórios
                </div>
              )}
            </div>
          ...
          {hasError ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 px-4 text-center border rounded-xl bg-background shadow-sm animate-fade-in">
              ...
              {canCreate && (
                <Button onClick={() => navigate('/relatorio/novo')}>
