    ...
    <div className="bg-slate-200 print:bg-white min-h-screen text-black font-sans pb-12 print:pb-0">
      ...
      <div className="fixed inset-0 z-0 flex items-center justify-center pointer-events-none opacity-[0.06] overflow-hidden">
        <img
          src={logoImg}
          alt="Watermark"
          className="w-[95vw] h-[95vh] print:w-[205mm] print:h-[290mm] object-contain -rotate-45"
        />
      </div>
                                      ...
                                      <span className="text-slate-900 break-words leading-tight">
                                        {typeof value === 'boolean'
                                          ...
                                          : eq.tipo_equipamento === 'Transformador' &&
                                            ...
                                            : key.startsWith('temporizacao_')
                                              ? formatNumberPtBR(value, 1, 1) || String(value)
                                              : key.startsWith('corrente_ajuste_')
                                                ? formatNumberPtBR(value, 0, 0) || String(value)
                                                : typeof value === 'number'
                              ...
                              <div className={`avoid-break ${sectionMargin}`}>
                                ...
                                <div className="border-l-4 border-slate-400 pl-3 py-1.5 bg-slate-50">
                                  ...
                                  >
                                    ...
                                    realizadas e os respectivos laudos encontram-se anexados ao
                                    final deste documento técnico.
                                  </span>
                                </div>
                              </div>
                            )}
